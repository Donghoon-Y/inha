...
% 진행하고, 최소교신각을 문제에 주어진 값인 10deg로 하여 교신 파라미터를 구한 결과는 intvls로 저장하였고 출력결과는 다음과 같다.
% 
% 
% 
...
% 시점의 값이 *29.6828 dBW로 EIRP를 설계해야 한다*.
...
% 2.3에서 항상 3dB의 마진을 유지하기 위해서 worst case인 29.6828 값을 이용하여 링크 마진을 계산하였다. 결과 그래프는 
% 다음과 같다.
% 
% 
% 
